...
const fetchMovieList = (params) => request.post("/movies/list", params);
const fetchMovieStats = () => request.get("/movies/stats");
const fetchMovieDetail = (movieId) => request.get(`/movies/${movieId}`);
const fetchMovieRegions = () => request.get("/movies/regions");
const fetchMovieLanguages = () => request.get("/movies/languages");
const fetchMovieTypes = () => request.get("/movies/types");
export {
  fetchMovieTypes as a,
  fetchMovieRegions as b,
  fetchMovieLanguages as c,
  fetchMovieList as d,
  fetchMovieDetail as e,
  fetchMovieStats as f,
  getPosterUrl as g,
  request as r
};
